<template>
  <div v-loading="loading">
    <div style="margin-top: 10px; display: flex; justify-content: center">
      ...
      <el-button type="primary" icon="el-icon-search" style="margin-left: 3px" @click="searchClick">搜索</el-button>
    </div>
      ...
      <el-card style="width:330px;margin-top:10px;" v-for="(user,index) in users" :key="index"
        ...
        <div slot="header" style="text-align: left">
          ...
          <el-button style="float: right; padding: 3px 0;color: #ff0509" type="text" icon="el-icon-delete"
                     @click="deleteUser(user.id)"></el-button>
        </div>
        <div>
          <div>
          ...
          <div
            ...
            <el-switch
                ...
                active-text="启用"
                active-color="#13ce66"
                @change="enableChange(user.enabled,user.id,index)"
